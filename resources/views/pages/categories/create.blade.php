...
@section('content')
    <section class="py-12 bg-slate-50 min-h-screen">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
            ...
            <div class="mb-8">
                <h1 class="text-3xl lg:text-4xl font-black text-slate-900 mb-2">Tambah Kategori</h1>
                <p class="text-slate-600">Buat kategori baru untuk mengorganisir pertanyaan</p>
            </div>
